...
//             <CustomButton onClick={signOut}>Logout</CustomButton>
//           </>
//         ) : (
//           <>
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              ...
              <div className="hidden md:flex items-center space-x-3">
                <Link to="/login" className="text-gray-700 hover:text-[#16A085] font-medium transition-colors">Login</Link>
                <Link to="/register">
                  <CustomButton className="bg-gradient-to-r from-[#16A085] to-[#2C3E50] hover:shadow-lg text-white px-6 py-2.5 rounded-xl font-medium transition-all duration-300">
                    Register
                  </CustomButton>
                </Link>
              </div>
