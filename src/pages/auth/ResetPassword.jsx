      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            Enter your email, OTP, and new password to securely reset your account.
          </p>
        </div>
        ...
        <div className="mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-green-700">
                For your security, never share your password with anyone and use different passwords for different accounts.
              </p>
            </div>
          </div>
        </div>
        ...
        {isLoading && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
              ...
              <p className="text-gray-700">Resetting your password...</p>
            </div>
          </div>
        )}
      </div>
