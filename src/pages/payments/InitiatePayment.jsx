...
const schema = Yup.object().shape({
  userId: Yup.number().required('User ID is required').positive('Must be a positive number'),
...
const InitiatePayment = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      console.error(error);
      setError('Failed to initiate payment. Please check your details and try again.');
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-green-700">
                        Payment initiated successfully! The user will receive a notification to complete the payment.
                      </p>
                    </div>
                  </div>
                </div>
