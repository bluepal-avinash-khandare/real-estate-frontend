...
//               <button className="bg-[#16A085] hover:bg-[#1abc9c] text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors shadow-lg">
//                 Explore Properties
//               </button>
...
//                         <div className="mb-4">
//                           <span className="bg-[#16A085] text-white px-3 py-1 rounded-full text-sm font-semibold">
//                             {property.type}
//                           </span>
//                         </div>
...
//                           </div>
//                         </div>
//                         <button className="w-full bg-[#16A085] hover:bg-[#1abc9c] text-white py-3 rounded-lg font-semibold transition-colors">
//                           View Details
//                         </button>
//                       </div>
//                     </div>
...
//       {/* CTA Section */}
//       <section className="py-20 bg-[#16A085] text-white">
...
//             <button className="bg-white text-[#16A085] hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition-colors shadow-lg">
//               Browse Properties
//             </button>
//             <button className="bg-transparent border-2 border-white hover:bg-white hover:text-[#16A085] text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors">
