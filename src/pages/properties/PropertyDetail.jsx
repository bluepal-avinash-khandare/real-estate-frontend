...
// // // //                   <button onClick={() => navigate('/request-appointment')} className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-[#16A085] to-[#2C3E50] hover:from-[#138871] hover:to-[#1a5f4f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#16A085]">
...
// // //         if (paymentStatus) {
// // //           const paymentData = JSON.parse(paymentStatus);
// // //           setHasPaid(paymentData.paid);
// // //         }
// // //       } catch (err) {
// // //         setError('Failed to fetch property details');
// // //         console.error(err);
...
// // //                     <p className="text-sm text-green-600 mt-1">You have already paid for this property viewing.</p>
// // //                     <button
...
// //   // Handle direct appointment navigation
// //  const handleAppointment = () => {
// //   // Navigate to appointment page with property details
...
//     } catch (err) {
//       setAppointmentError('Failed to submit appointment request');
//       console.error(err);
//     } finally {
//       setSubmitting(false);
//     }
...
//         customerId: userId,
//         propertyId: id,
//         agentId: property.agentId, // Include agent ID from property
//         date: appointmentDate,
//         time: appointmentTime,
//         message: appointmentMessage,
//         paymentToken: hasPaid ? localStorage.getItem(`payment_${id}_user_${userId}`)?.paymentToken || null : null
//       };
...
//         // FIXED: Check if verification was successful before proceeding
//         if (verificationResponse.success && verificationResponse.data.verified) {
...
//                       onError={(e) => {
//                         e.target.onerror = null; 
//                         e.target.src = 'data:image/svg+xml;base64,';
//                       }}
//                     />
//                   </div>
