      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Manage and track all your property investments in one place
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {properties.length > 0 
                    ? `${(properties.reduce((sum, prop) => sum + (prop.returnRate || 0), 0) / properties.length).toFixed(1)}%`
                    : '0%'
                  }
                </p>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">Your Investment Portfolio</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="mt-1 text-gray-500 max-w-md mx-auto">
                You haven't invested in any properties yet. Start building your portfolio today.
              </p>
              <div className="mt-6">
                <button className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-[#16A085] to-[#2C3E50] hover:from-[#138871] hover:to-[#1a5f4f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#16A085]">
                  Explore Properties
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Portfolio Tracking</h3>
            </div>
            <p className="text-gray-600">Monitor the performance of all your property investments in real-time.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Growth Insights</h3>
            </div>
            <p className="text-gray-600">Get detailed analytics on property appreciation and rental income.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold text-gray-900">Investment Tips</h3>
            </div>
            <p className="text-gray-600">Receive personalized recommendations to optimize your real estate portfolio.</p>
          </div>
        </div>

        {/* Footer Note */}
        <div className="mt-8 text-center text-gray-500 text-sm">
          <p>Need help with your investments? Contact our support team for assistance.</p>
        </div>
      </div>
    </div>
  );
